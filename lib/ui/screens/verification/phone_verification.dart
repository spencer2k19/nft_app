...
class PhoneVerification extends StatelessWidget {
   bool? reset;
  PhoneVerification({Key? key,this.reset = false}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Enter your phone number", style: titleStyleHeading,),
              const SizedBox(height: 15,),
              Padding(
              ...
              HintInputWidget(label: "+1 607 218 4860",
              ...
              FilledButton(title: "Send code",
                  handler: (){
                    if(reset!) {
                      locator<NavigationService>().navigateTo(Routes.resetPassword);
                    } else {
